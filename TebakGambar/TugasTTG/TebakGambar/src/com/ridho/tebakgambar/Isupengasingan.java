...
public class Isupengasingan extends Activity {
	EditText jawabanTxt;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_isupengasingan);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.isupengasingan, menu);
		return true;
	}
	 public void cekJawaban(View v){
	    	String jawabanBenar = "ISU PENGASINGAN";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Kalibasibaterai.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
