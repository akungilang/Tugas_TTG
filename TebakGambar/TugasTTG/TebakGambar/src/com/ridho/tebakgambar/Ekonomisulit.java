...
public class Ekonomisulit extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ekonomisulit);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ekonomisulit, menu);
		return true;
	}
	 public void cekJawaban(View v){
	    	String jawabanBenar = "EKONOMI SULIT";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Energigitaris.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
