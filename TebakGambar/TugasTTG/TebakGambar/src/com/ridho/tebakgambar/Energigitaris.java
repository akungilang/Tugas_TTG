...
public class Energigitaris extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_energigitaris);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.energigitaris, menu);
		return true;
	}
	 public void cekJawaban(View v){
	    	String jawabanBenar = "ENERGI GITARIS";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Isupengasingan.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
