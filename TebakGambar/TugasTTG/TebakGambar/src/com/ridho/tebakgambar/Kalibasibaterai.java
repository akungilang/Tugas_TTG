...
public class Kalibasibaterai extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_kalibasibaterai);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kalibasibaterai, menu);
		return true;
	}
	  public void cekJawaban(View v){
	    	String jawabanBenar = "KALIBRASI BATERAI";
