...
public class BabingorokActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_babingorok);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.babingorok, menu);
		return true;
	}
	public void cekJawaban(View v){
    	String jawabanBenar = "BABI NGOROK";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),Akupucat.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
