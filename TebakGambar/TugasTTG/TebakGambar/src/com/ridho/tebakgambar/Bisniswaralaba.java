...
public class Bisniswaralaba extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bisniswaralaba);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bisniswaralaba, menu);
		return true;
	}
	 public void cekJawaban(View v){
	    	String jawabanBenar = "BISNIS WIRALABA";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),Ekonomisulit.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
