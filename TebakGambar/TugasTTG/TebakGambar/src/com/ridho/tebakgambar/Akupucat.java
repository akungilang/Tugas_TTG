...
public class Akupucat extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_akupucat);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.akupucat, menu);
		return true;
	}
    public void cekJawaban(View v){
    	String jawabanBenar = "AKU PUCAT";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),Bisniswaralaba.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
